...
exports.ical_events = function(ical, event_callback, recur_event_callback) {
    jcal_events(ical, event_callback, recur_event_callback)
}

exports.jcal_events = function(jcal, event_callback, recur_event_callback) {
